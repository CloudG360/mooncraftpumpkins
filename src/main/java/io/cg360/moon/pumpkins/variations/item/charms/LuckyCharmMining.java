...
public class LuckyCharmMining extends PumpkinLuckyRoll {
    ...
    protected void run(Player player, Location<World> loc, int luckmult){
        ...
        itemStack.offer(Keys.ITEM_LORE, Arrays.asList(
                    ...
                    Text.of(TextColors.GRAY, "Gives you Night Vision and"),
                    Text.of(TextColors.GRAY, "Haste 4 when held in the"),
                    Text.of(TextColors.GRAY, "off hand.")
                ));
        ...
        player.sendMessage(Text.of(TextColors.GOLD, TextStyles.BOLD, "TREAT", TextStyles.RESET, TextColors.GOLD, " You got a Mining Charm!"));
    }
}
