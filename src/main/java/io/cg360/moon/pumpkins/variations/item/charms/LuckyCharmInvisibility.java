...
public class LuckyCharmInvisibility extends PumpkinLuckyRoll {
    ...
    protected void run(Player player, Location<World> loc, int luckmult){
        ...
        itemStack.offer(Keys.ITEM_LORE, Arrays.asList(
                    ...
                    Text.of(TextColors.DARK_PURPLE, "Gives you Invisibility"),
                    Text.of(TextColors.DARK_PURPLE, "when held in the off hand.")
                ));
        ...
        player.sendMessage(Text.of(TextColors.GOLD, TextStyles.BOLD, "TREAT", TextStyles.RESET, TextColors.GOLD, " You got a Invisibility Charm!"));
    }
}
