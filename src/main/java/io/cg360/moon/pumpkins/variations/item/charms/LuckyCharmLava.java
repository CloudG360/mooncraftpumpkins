...
public class LuckyCharmLava extends PumpkinLuckyRoll {
    ...
    protected void run(Player player, Location<World> loc, int luckmult){
        ...
        itemStack.offer(Keys.ITEM_LORE, Arrays.asList(
                    ...
                    Text.of(TextColors.GOLD, "Protects you from lava and"),
                    Text.of(TextColors.GOLD, "fire damage when held in "),
                    Text.of(TextColors.GOLD, "off hand.")
                ));
        ...
        player.sendMessage(Text.of(TextColors.GOLD, TextStyles.BOLD, "TREAT", TextStyles.RESET, TextColors.GOLD, " You got a Lava Charm!"));
    }
}
