...
public class LuckyCharmLife extends PumpkinLuckyRoll {
    ...
    protected void run(Player player, Location<World> loc, int luckmult){
        ...
        itemStack.offer(Keys.DISPLAY_NAME, Text.of(TextColors.LIGHT_PURPLE, TextStyles.BOLD, "Life Charm"));
        itemStack.offer(Keys.ITEM_LORE, Arrays.asList(
                    Text.of(TextColors.BLACK, "health_charm"),
                    Text.of(TextColors.LIGHT_PURPLE, "Gives you more hearts"),
                    Text.of(TextColors.LIGHT_PURPLE, "when held in the off hand.")
                ));
